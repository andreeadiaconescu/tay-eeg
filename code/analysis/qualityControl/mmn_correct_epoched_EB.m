function [ D ] = dmpad_correct_epoched_EB( D, details, options )
%DMPAD_CORRECT_EPOCHED_EB Applies the EB correction method used during preprocessing to the EEG data
%set wich was epoched to the onset of all detected eye blinks. Can be used to examine the effects of
%the correction on the average eyeblink.
...
SRC = tnueeg_bergscherg_source_waveforms(Dprep, options.preproc.eyeCorrMethod);
