function mmn_ignore_reject_badtrials(id, options)
%
% IN
...
if strcmpi(options.eeg.preproc.eyeCorrMethod, 'reject') && ...
    ...
    design = getfield(load(details.eeg.firstLevelDesignFileEBPruned), 'design');
else
    design = getfield(load(details.eeg.firstLevelDesignFileInit), 'design');
end
fns = fieldnames(design);
...
% save pruned design
save(details.eeg.firstLevelDesignFilePruned, 'design');
end
